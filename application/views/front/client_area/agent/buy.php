                      	...
                      	<div class="col-md-12">
                          	...
                          	<table width="100%">
                                <tr>
                                  ...
                                  <td width="802"><?php print $username; ?>
                                  <input class="form-control" name="username" type="hidden" value="<?php print $username; ?>" required>
                              	<input class="form-control" name="agent_id" type="hidden" value="<?php print $ID; ?>" required></td>
                                </tr>
                                <tr>
                                  <td><strong>Sponsor ID</strong></td>
                                  <td align="center"><strong>:</strong></td>
                                  <td><?php print $spon_name; ?>
                                  <input class="form-control" name="spon_name" type="hidden" value="<?php print $spon_name; ?>" required>
                                  </td>
                                </tr>
                                <tr>
                          	...
                          	<a href="<?php print base_url(); ?>store/">Continue to Shoping</a>
                              <?php } ?>
                        </div>
                      </div>
              </div>
