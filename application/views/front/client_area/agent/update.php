		    	...
		    	<div class="right_contant dashboard_right">
              		<div class="top_right_content">
                  		...
                  		<?php if ($row->status == "Inactive") { ?>
	                          ...
	                          Sorry! But your account is not active yet!. PLease <a href="<?php print base_url(); ?>agent/general/load_money/">load balance</a> to your account and <a href="#">Active.</a>
	                      	</div>
                            ...
                            <div class="panel-body">
                                <div class="tab-content">
                                    <div class="tab-pane fade active in" id="tab1default">
                                    	<form role="form" id="add_user" method="post" action="<?php print base_url(); ?>agent/profile/profile_update_action"> 
	                                    	<div class="col-lg-6">
	                                        	<div class="form-group">
				                                    <label>First Name <sup class="required"></sup></label>
				                                    <?php echo form_error('fname', '<p class="error">', '</p>'); ?>
				                                    <input class="form-control" name="fname" type="text" value="<?php echo $value->f_name; ?>" >
				                                </div>
				                                <div class="form-group">
				                                    <label>Last Name <sup class="required"></sup></label>
				                                    <?php echo form_error('lname', '<p class="error">', '</p>'); ?>
				                                    <input class="form-control" name="lname" type="text" value="<?php echo $value->l_name; ?>" >
				                                </div>
				                                <div class="form-group">
				                                    <label>Present Addres <sup class="required"></sup></label>
				                                    <?php echo form_error('addr', '<p class="error">', '</p>'); ?>
				                                    <input type="text" class="form-control" name="addr" value="<?php echo $value->address1; ?>" >
				                                </div>
				                                <div class="form-group">
				                                    <label>Permanent Addres <sup class="required"> </sup></label>
				                                    <?php echo form_error('per_addr', '<p class="error">', '</p>'); ?>
				                                    <input type="text" class="form-control" name="per_addr" value="<?php echo $value->address2; ?>" >
				                                </div>
			                            	...
			                            	<div class="col-lg-6">
			                            		<div class="form-group">
			                                        ...
			                                        <div class="form-group">
			                                            ...
			                                            <input class="form-control" name="father" type="text" value="<?php echo $value->father; ?>" >
			                                        </div>
			                                        <div class="form-group">
			                                            <label>Mother Name <sup class="required">*</sup></label>
			                                            <?php echo form_error('mother', '<p class="error">', '</p>'); ?>
			                                            <input class="form-control" name="mother" type="text" value="<?php echo $value->mother; ?>" >
			                                        </div>
                                    ...
                                    <div class="tab-pane fade in" id="tab2default">
                                    	<form role="form" id="add_user" method="post" action="<?php print base_url(); ?>agent/profile/personal_update_action">
                                        	<div class="col-lg-6">
                                    ...
                                    <div class="tab-pane fade in" id="tab3account">
                                    	<form role="form" id="add_user" method="post" action="<?php print base_url(); ?>agent/profile/account_update_action" >
	                                    	<div class="col-lg-6">
	                                    		<div class="form-group">
                                    ...
                                    <div class="tab-pane fade in" id="tab3photo">
                                    	...
                                    	<form role="form" id="add_user" method="post" action="<?php print base_url(); ?>agent/profile/photo_update_action" enctype="multipart/form-data" >
	                                    	<div class="form-group">
