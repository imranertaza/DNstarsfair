        ...
        <div class="col-md-3">
            ...
            <div class="footer_menu">
                <ul>
                    ...
                    <li><a href="<?php print base_url(); ?>teacher.html">Products</a></li>
                    <li><a href="<?php print base_url(); ?>gallery.html">Event Gallery</a></li>
                    <li><a href="<?php print base_url(); ?>details/page/history.html">About Us</a></li>
                    <li><a href="<?php print base_url(); ?>details/page/contact-us.html">Conatct Us</a></li>
                </ul>
...
<div class="short_footer short_footerl">
	<div class="container">  
    <div class="row">
    <div class="col-md-12 short_footer_write">Copyright © 2019 | All rights reserved.</div><!--end of short_footer_write-->
    </div>
    </div>
</div>
