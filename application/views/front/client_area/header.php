...
<div class="container">
    <div class="row">
        	<div class="row">
                <div class="col-md-3">
                    <strong style="margin-top:5px;"><a href="<?php echo base_url(); ?>">Libaral International Limited</a></strong>
                </div>
...
<!--                <li><a href="--><?php //echo base_url(); ?><!--product/">Products</a></li>-->
                ...
                <li><a href="<?php print base_url(); ?>member/general/dashboard/">My Area</a></li>
