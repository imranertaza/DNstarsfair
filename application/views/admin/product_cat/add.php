                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">
                            <?php print $msg = $this->category_mod->add_new_category();
							if ($msg) {
							?>
                            <meta http-equiv="refresh" content="2;URL=<?php print base_url(); ?>category/add_category.html" />
                            <?php } ?>
                                ...
                                <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                        	<select class="form-control" name="perent">
                                            	...
                                            	<?php print $this->category_mod->category_option_list(); ?>
                                            </select>
                                        </div>
