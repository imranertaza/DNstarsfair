<?php $get_category = $this->db->query ("SELECT * FROM `product_cat` WHERE `cat_id` = '$cat_id'")->row(); ?>
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
							...
							if ($msg) {
							?>
                            <meta http-equiv="refresh" content="2;URL=<?php print base_url(); ?>product_cat/edit/<?php print $cat_id; ?>.html" />
                            <?php } ?>
