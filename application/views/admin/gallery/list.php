<div id="page-wrapper">
            ...
            <ul class="nav nav-tabs">
              <li class="active"><a href="<?php echo base_url(); ?>general_settings/gallery.html">Image List</a></li>
              <li><a href="<?php echo base_url(); ?>general_settings/upload_image_gallery.html">Upload</a></li>
            </ul>
