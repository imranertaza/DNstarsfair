                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" value="<?php   print $row['f_name']; ?>" name="fname" type="text" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" value="<?php   print $row['l_name']; ?>" name="lname" type="text" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="addr" cols="5" rows="3" required><?php print $row['address1']; ?></textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="per_addr" cols="5" rows="3" required><?php print $row['address2']; ?></textarea>
                                            <p class="help-block">Please put your address</p>
                                        </div>
                                        <div class="form-group">
                                            <label>Phone</label>
                                            <?php echo form_error('phone', '<p class="error">', '</p>'); ?>
                                            <input value="<?php print $row['phn_no']; ?>" class="form-control" name="phone" type="text" required>
                                            <p class="help-block">Please put your phone</p>
                                        </div>
                                        <div class="form-group">
                                            <label>National ID </label>
                                            <?php echo form_error('nid', '<p class="error">', '</p>'); ?>
                                            <input value="<?php print $row['nid']; ?>" class="form-control" name="nid" type="text">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" value="<?php print $row['father']; ?>" name="father" type="text" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input value="<?php print $row['mother']; ?>" class="form-control" name="mother" type="text" required>
                                ...
                                <div class="col-lg-4">
                                		...
                                		<div class="form-group">
                                            ...
                                            <select name="division" class="form-control" onchange="get_district(this.value);" required>
                                                ...
                                                <?php print get_location(0, $row['division']); ?>
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="post_code" type="text" value="<?php print $row['post']; ?>"  required>
                                ...
                                <div class="col-lg-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="non" value="<?php print $row['nominee']; ?>" type="text" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="account_no" value="<?php print $row['account_no']; ?>" type="text" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="uname" type="text" onchange="check_valid_username(this.value)" value="<?php print $row['username']; ?>" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="email" type="text" id="email" onchange="validate()" value="<?php print $row['email']; ?>" required>
                                            <p class="help-block" id="result">Please put your user email (it will be used for login)</p>
                                        </div>
                                        <input type="submit" class="btn btn-default btn btn-primary" value="Update Member" name="edit_user" />
                                </div>
                                </form>
                                <!-- /.col-lg-6 (nested) -->
                            </div>
