                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <tr>
                          ...
                          <td>&nbsp;</td>
                          <td>&nbsp;</td>
                          <td colspan="2" align="center"><a class="parent" href="<?php print base_url(); ?>member_form/my_tree/<?php print $u_id; ?>/">
                        <img src="<?php print base_url(); ?>uploads/widget_image/no_thumb.jpg" class="profile_img"  /><br>
                        ...
                        <tr>
                          ...
                          <td colspan="6" style="text-align: center;"><a href="<?php print base_url(); ?>member_form/my_tree/<?php print $p_left; ?>/">
                        <img src="<?php print base_url(); ?>uploads/widget_image/no_thumb.jpg" class="profile_img level"  /><br>
                        <?php 
                        ...
                        ?>
                          ...
                          <td colspan="6" style="text-align: center;"><a href="<?php print base_url(); ?>member_form/my_tree/<?php print $p_right; ?>/">
                        <img src="<?php print base_url(); ?>uploads/widget_image/no_thumb.jpg" class="profile_img level"  /><br>
                        <?php 
                        ...
                        <tr>
                          <td colspan="3" style="text-align: center;"><a href="<?php print base_url(); ?>member_form/my_tree/<?php print $p_l_left; ?>/">
                        <img src="<?php print base_url(); ?>uploads/widget_image/no_thumb.jpg" class="profile_img leve2"  /><br>
                        <?php 
                        ...
                        ?>
                          ...
                          <td colspan="3" style="text-align: center;"><a href="<?php print base_url(); ?>member_form/my_tree/<?php print $p_l_right; ?>/">
                        <img src="<?php print base_url(); ?>uploads/widget_image/no_thumb.jpg" class="profile_img leve2"  /><br>
                        <?php 
                        ...
                        ?>
                          ...
                          <td colspan="3" style="text-align: center;"><a href="<?php print base_url(); ?>member_form/my_tree/<?php print $p_r_left; ?>/">
                        <img src="<?php print base_url(); ?>uploads/widget_image/no_thumb.jpg" class="profile_img leve2"  /><br>
                        <?php 
                        ...
                        ?>
                          ...
                          <td colspan="3" style="text-align: center;"><a href="<?php print base_url(); ?>member_form/my_tree/<?php print $p_r_right; ?>/">
                        <img src="<?php print base_url(); ?>uploads/widget_image/no_thumb.jpg" class="profile_img leve2"  /><br>
                        <?php 
