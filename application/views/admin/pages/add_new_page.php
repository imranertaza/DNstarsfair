                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">
                            	<?php print $report = $this->page->add_new_page();
								if ($report) {
								?>
                                <meta http-equiv="refresh" content="2;URL=<?php print base_url(); ?>pages/add_new_page.html" />
                                </div>
                                <div class="col-lg-12">
                                <?php } ?>
                            	<form method="post" action="">
                                        <div class="form-group col-lg-8">
                                            ...
                                            <input class="form-control" name="page_tilte" value="">
