                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                <?php print $report = $this->page->edit_page($page_id);
								if ($report) {
								?>
                                <meta http-equiv="refresh" content="2;URL=<?php print base_url(); ?>pages/edit_page/<?php print $page_id; ?>.html" />
                                </div>
                                <div class="col-lg-12">
                                <?php } ?>
                                    <form method="post" action="">
                                        <div class="form-group col-lg-8">
                                            ...
                                            <input class="form-control" name="page_tilte" value="<?php print $row['page_title']; ?>">
                                        ...
                                        <div class="form-group col-lg-8">
                                            ...
                                            <textarea class="form-control" name="short_description" rows="3"><?php print $row['short_des']; ?></textarea>
                                        ...
                                        <label>Page Template</label>
                                            <select class="form-control" name="page_template">
                                                ...
                                                <?php $this->page->find_template($page_id); ?>
                                            </select>
